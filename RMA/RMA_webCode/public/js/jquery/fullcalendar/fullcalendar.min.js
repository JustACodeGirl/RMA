...
function EventManager(options) { // assumed to be a calendar
	...
	function fetchEvents(start, end) {
		...
		//if(sources.length >= 2 && sources[1]['events'] && sources[1]['origArray']){
		//	if(sources[1]['events'].length < sources[1]['origArray'].length){
		//		sources[1] = buildEventSource(sources[1]['origArray']);
		//	}
		//}
